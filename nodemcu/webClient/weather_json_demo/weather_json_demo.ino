...
程序名称/Program name     : weather_json_demo
 ...
 */
  ...
  // 建立字符串，用于HTTP请求
  String httpRequest =  String("GET /v3/weather/now.json?key=SCXC4Mj_0aB96cZup&location=beijing&language=en&unit=c") + " HTTP/1.1\r\n" +
                        "Host: " + host + "\r\n" +
                        "Connection: close\r\n" +
                        "\r\n";
